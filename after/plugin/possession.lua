...
-- Add keymaps for Possession
vim.keymap.set('n', '<leader>pll', '<cmd>PossessionLoad<cr>', { desc = 'Load last session' })
vim.keymap.set('n', '<leader>pss', '<cmd>PossessionSave<cr>', { desc = 'Save session' })
vim.keymap.set('n', '<leader>pl', '<cmd>Telescope possession list<cr>', { desc = 'List sessions' })
